...
% 'mT': Consistent with the variable in the main program  % % 2021.7.17
% cannot use 'T', or an error will be reported after the first grid
global mT;
if ~isfield(options,'T')&&isempty(mT);
...
% 'mST': Consistent with the variable in the main program  % % 2021.7.17
% cannot use 'ST', or an error will be reported after the first grid
global mST; 
